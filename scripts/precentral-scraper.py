    ...
    def endElement(self,name):
        ...
        if ((name == "application") or (name == "theme")):
            ...
            if (m):
                ...
                if (name == "theme"):
                    id = "net.precentral.themes." + self.title.strip().lower().replace("&#58; ","-").replace("_quick_install_2.0","").replace("_","-").replace(": ","-").replace("  "," ").replace(" ","-").replace(".","").replace("'","").replace("(","").replace(")","").replace("+","").replace("!","").replace("/","").rstrip("-") + "_" + self.version + "_all"
